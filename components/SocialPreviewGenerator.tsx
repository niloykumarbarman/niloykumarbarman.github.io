...
const SocialPreviewGenerator = ({
  ...
  description = "Expert Full-Stack .NET Developer with 1+ years experience. Specializing in scalable applications, cloud solutions with .NET, React, Azure & AWS. Microsoft Certified.",
  image = "https://niloykumarbarman.github.io/assets/profile/profile-large.webp",
