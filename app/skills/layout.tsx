...
export const metadata: Metadata = {
  ...
  description: "Comprehensive overview of Niloy Kumar Barman's technical expertise including .NET, React, cloud technologies, databases, DevOps tools, and modern development frameworks.",
  keywords: [
    "technical skills",
